...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="{{ asset('css/material-design-iconic-font.css') }}">
    ...
    <link type="text/css" rel="stylesheet" href="{{ asset('css/widgets.css') }}">
    <link type="text/css" rel="stylesheet" href="{{ asset('css/plugins.css') }}">
    <link type="text/css" rel="stylesheet" href="{{ asset('css/pages.css') }}">
    <link type="text/css" rel="stylesheet" href="{{ asset('css/bootstrap-extend.css') }}">
...
<script src="{{ asset('js/lib/login-validation.js') }}"></script>
</body>
